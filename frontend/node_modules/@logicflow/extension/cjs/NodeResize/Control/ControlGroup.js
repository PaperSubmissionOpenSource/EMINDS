...
var ControlGroup = /** @class */ (function (_super) {
    ...
    ControlGroup.prototype.getResizeControl = function () {
        ...
        return controlList.map(function (control, index) { return (preact_1.h(Control_1.default, __assign({ index: index }, control, { nodeModel: nodeModel, graphModel: graphModel }))); });
    };
